...
Make sure that you also [set your project or account API Token](index.md#2-uploading-coverage-reports-to-codacy) as an environment variable in your Travis CI job.
